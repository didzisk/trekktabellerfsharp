module internal Skattetabell2017internal
...
let ``WS-KLASSE-FRADRAG`` klasseSkatteProsent =
    let ``KLASSE1-VANLIG``   = 53150M
    let ``KLASSE2-VANLIG``   = 78300M
    let ``KLASSE1-FINNMARK`` = 68650M
    let ``KLASSE2-FINNMARK`` = 93800M
...
let ``TRINNSKATT-PROSENT`` levelSkatteProsent = 
    ...
    *-----------------------------------------------------------------*)
let ``FELLES-SKATT-VANLIG``   = 9.55M
let ``FELLES-SKATT-FINNMARK`` =  6.05M
let SKATTORE                  = 14.45M
...
(*-----------------------------------------------------------------
    ...
    * DET VIL ALTSÅ SI:
     *     (X - 54650) * 0.25 = X * 0.082(ELLER 0.051 VED LAV)
     *                      X = 81324 (VED HØY TRYGDEAVGIFT)
     *                      X = 68656 (VED LAV TRYGDEAVGIFT)
      *-----------------------------------------------------------------
          05  LAV-GRENSE-TRYGDEAVGIFT  PIC 9(6)          VALUE 68656.
          05  HOY-GRENSE-TRYGDEAVGIFT  PIC 9(6)          VALUE 81324.
           05  TRYGDE-PROSENT           PIC 99            VALUE 25.
           05  LAV-TRYGDEAVG-PROSENT    PIC 99V99         VALUE 5,1.
           05  HOY-TRYGDEAVG-PROSENT    PIC 99V99         VALUE 8,2.
          05  AVG-FRI-TRYGDEAVGIFT     PIC 9(6)          VALUE 54650.
    *-----------------------------------------------------------------*)
let ``LAV-GRENSE-TRYGDEAVGIFT`` = 68656M
let ``HOY-GRENSE-TRYGDEAVGIFT`` = 81324M
let ``TRYGDE-PROSENT``          = 25M
let ``LAV-TRYGDEAVG-PROSENT``   = 5.1M
let ``HOY-TRYGDEAVG-PROSENT``   = 8.2M
let ``AVG-FRI-TRYGDEAVGIFT``    = 54650M
...
(*-----------------------------------------------------------------
    ...
    *-----------------------------------------------------------------*)
let ``ANV-MINSTE-FRAD-PROSENT``       = 38.72M
let ``ANV-MINSTE-FRAD-PROSENT-PENSJ`` = 25.52M
let ``MIN-ANV-MINSTE-FRADRAG``        = 3520M
let ``MAX-ANV-MINSTE-FRADRAG``        = 83380M
let ``MAX-ANV-MINSTE-FRADRAG-PENSJ``  = 66000M
(*-----------------------------------------------------------------
    * MINSTEFRADRAG
    *-----------------------------------------------------------------*)
let ``MINSTE-FRAD-PROSENT``      = 44M
let ``MIN-MINSTE-FRADRAG``       = 4000M
let ``MAX-MINSTE-FRADRAG``       = 94750M
(*-----------------------------------------------------------------
    * LØNNSFRADRAG
    *-----------------------------------------------------------------*)
...
let beregnForskuddstrekkInternal (trekkgrunnlag:int) tabellnummer pensjonist (tabbtrekkperiode:int) =
    ...
    let interne:InterneVerdier =
        {
            ...
            ``WS-TREKK-GRLAG``=decimal trekkgrunnlag;
            antTrekkPerioder=0M;
